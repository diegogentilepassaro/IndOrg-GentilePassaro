...
Finally, I obtain $\hat{v(2)}$ by taking a weighted average over $\hat{v(2)}(S^k)$ where the weights are given by the number of counties per bin. A graphical report of the results for the case using 7 bins is below:
